...
public class SigningRuntimeImagePackageTest {
    ...
    private static void verifyPKG(JPackageCommand cmd) {
        System.out.println("AMDEBUG verifyPKG()");
    ...
    private static void verifyDMG(JPackageCommand cmd) {
        System.out.println("AMDEBUG verifyDMG()");
        Path outputBundle = cmd.outputBundle();
    ...
    private static void verifyRuntimeImageInDMG(JPackageCommand cmd,
        ...
        MacHelper.withExplodedDmg(cmd, dmgImage -> {
            System.out.println("AMDEBUG verifyRuntimeImageInDMG() isRuntimeImageSigned: " + isRuntimeImageSigned);
            System.out.println("AMDEBUG verifyRuntimeImageInDMG() JDKBundleCertIndex: " + JDKBundleCertIndex);
    ...
    private static Path getRuntimeImagePath(boolean useJDKBundle,
        ...
        if (useJDKBundle) {
            ...
            if (isRuntimeImageSigned) {
                ...
                System.out.println("AMDEBUG SigningBase.getDevName(JDKBundleCertIndex): " + SigningBase.getDevName(JDKBundleCertIndex));
        ...
        new PackageTest()
                ...
                .addBundleVerifier(cmd -> {
                    verifyRuntimeImageInDMG(cmd, isRuntimeImageSigned || isSigned,
                        isRuntimeImageSigned ? JDKBundleCertIndex : signCertIndex);
                })
                .run();
    }
}
